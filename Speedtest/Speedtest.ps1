...
$MinimumDownloadSpeed = 20 #What is the minimum expected download speed in Mbit/ps
$MinimumUploadSpeed = 5 #What is the minimum expected upload speed in Mbit/ps
...
$DownloadURL = "https://cardonetcouk.sharepoint.com/sites/SupportFiles/_layouts/15/download.aspx?docid=0904cfa7c936945d49b7abcfd0ee860a3&authkey=AbGn-Y7MIRhn9TNSpUkt8EI&e=vedRKm"
